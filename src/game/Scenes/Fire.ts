...
export default class Fire extends BaseStage {
    ...
    loadScene(){
        ...
        this.load.tilemap("level", "game_assets/tilemaps/fire.json");// TODO: switch to fire map
        this.load.object("board", "game_assets/data/fire_board.json");// TODO: switch to fire board
